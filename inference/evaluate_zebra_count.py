...
# gpu指定 4,5,6,7
source /home/xiaojunhao/miniconda3/etc/profile.d/conda.sh && conda activate monet && export LATENT_SIZE=10 && CUDA_VISIBLE_DEVICES=4,5,6,7 python -m inference.evaluate_zebra_count
"""
...
def main():
    ...
    # 1. 评估 Zebra_CoT_count 数据集 (小样本测试)
    evaluate_dataset(
        os.path.join(base_dir, "Zebra_CoT_count/train.json"),
        "/home/xiaojunhao/m-x/inference/results/Zebra_CoT_count_results.csv",

...
# gpu指定 0,1,2,3
source /home/xiaojunhao/miniconda3/etc/profile.d/conda.sh && conda activate monet && export LATENT_SIZE=10 && CUDA_VISIBLE_DEVICES=0,1,2,3 python -m inference.evaluate_cogcom
"""
...
def main():
    ...
    # 1. 评估 CogCoM 数据集 (小样本测试)
    evaluate_dataset(
        os.path.join(base_dir, "CogCoM/train.json"),
        "/home/xiaojunhao/m-x/inference/results/CogCoM_results.csv",
